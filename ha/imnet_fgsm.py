...
TODO! make sure to normalize before feeding into network
EVERY TIME!
Compute this threshold point for each and every image in training or validation and keep the historgram/list of these values to check against. 
