...
# plot the histogram of adversarial class
# plot it on that histogram
fig= plt.figure()
plt.hist(np.log(b3vv), 100)
plt.scatter(np.log(b2["a_var"]),1, color="red")
fig.set_size_inches(24,12)
fo = odir+"/"+str(a_class)+"-hist.png"
fig.savefig(fo, dpi=100)  
